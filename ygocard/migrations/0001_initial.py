# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-09-25 08:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='card',
            name='card_rarity',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='card_rarity', to='ygocard.CardRarity'),
        ),
        migrations.AddField(
            model_name='card',
            name='card_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='card_type', to='ygocard.CardType'),
        ),
        migrations.AddField(
            model_name='card',
            name='monster_ability',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='monster_ability', to='ygocard.MonsterAbility'),
        ),
        migrations.AddField(
            model_name='card',
            name='monster_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='monster_type', to='ygocard.MonsterType'),
        ),
        migrations.AddField(
            model_name='card',
            name='monster_type_1',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='monster_type_1', to='ygocard.MonsterType1'),
        ),
        migrations.AddField(
            model_name='card',
            name='monster_type_2',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='monster_type_2', to='ygocard.MonsterType2'),
        ),
        migrations.AddField(
            model_name='card',
            name='spell_trap_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='spell_trap_type', to='ygocard.SpellTrapType'),
        ),
    ]
